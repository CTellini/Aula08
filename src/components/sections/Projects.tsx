...
const projects: Project[] = [
  ...
  },
  {
    ...
    details: {
      overview: "A NORA é uma super agente criada em n8n, que entende texto, imagem e voz — e pode fazer demonstrações automáticas do seu trabalho de automação para impressionar leads e fechar contratos com mais facilidade.",
      features: [
